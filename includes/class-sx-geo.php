...
define ('SXGEO_FILE_NGP', 0);
define ('SXGEO_MEMORY_NGP', 1);
define ('SXGEO_BATCH_NPG',  2);
class SxGeo_NGP {
	protected $fh;
	protected $ip1c;
	protected $info;
	...
	public function __construct($db_file = 'SxGeo.dat', $type = SXGEO_FILE_NGP){
		...
		$this->batch_mode  = $type & SXGEO_BATCH_NPG;
		$this->memory_mode = $type & SXGEO_MEMORY_NGP;
